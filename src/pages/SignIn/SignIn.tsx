...
export const SignIn = ({ sideBarIsOpen }: SignInProps) => {
    ...
    <Container sideBarIsOpen={sideBarIsOpen}>
      <Wrapper>
        <FormGroup>
          ...
          <Input placeholder='password' type='password' onChange={e => setPassword(e.target.value.trim())} />

          <Button onClick={() => handleSign('signin')}>Sign in</Button>

          <Button onClick={() => handleSign('google')}>Signin with Google</Button>
